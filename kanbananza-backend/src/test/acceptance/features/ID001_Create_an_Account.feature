Feature: Create an Account
  As a User, I want to create an account so that I can make use of the Kanban capabilities of the system
  ...
  Scenario: Unsuccessfully create an account with a valid but existing email (Error Flow)
    ...
    Then the system shall report "Email 'johnsmith@mail.com' is already in use"
  ...
  Scenario: Unsuccessfully create an account with an invalid yet unused email (Error Flow)
    ...
    Then the system shall report "Email '<email>' is invalid'"
