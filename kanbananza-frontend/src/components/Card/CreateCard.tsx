...
const CreateCard = () => {// maybe just display this under the board? 
    ...
    const onSubmit = () => {
        ...
        history.push({ pathname: '/board', state: { boardData: history.location.state.boardData } })
    }
    const onCancel = () => { // check that
        setCardDescription("");
        setCardTitle("")
    }
